...
p.textContent='This is the task to create a pagination that contains 100 pages.'
...
let col=document.createElement('tc');
let row1=document.createElement('tr');
row1.textContent="Click";
...
row2.append(pagination);
pagination.append(div1);
